;;; Example in clojure (and ergo lisp) of the retry resource example 
...
;; The initial reference, defined in Haskell as 
...
(defn retry-invariant-control [x] 
  (dosync
    (if (< x @resource) false true)))

(set-validator! resource retry-invariant-control)
